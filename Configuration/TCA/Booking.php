	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_hotelbooking_domain_model_booking',
				'foreign_table_where' => 'AND tx_hotelbooking_domain_model_booking.pid=###CURRENT_PID### AND tx_hotelbooking_domain_model_booking.sys_language_uid IN (-1,0)',
			),
		),
		...
		'begin_date' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:hotel_booking/Resources/Private/Language/locallang_db.xlf:tx_hotelbooking_domain_model_booking.begin_date',
			'config' => array(
				'type' => 'input',
				'size' => 10,
				'eval' => 'datetime',
		...
		'end_date' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:hotel_booking/Resources/Private/Language/locallang_db.xlf:tx_hotelbooking_domain_model_booking.end_date',
			'config' => array(
				'type' => 'input',
				'size' => 10,
				'eval' => 'datetime',
		...
		'price' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:hotel_booking/Resources/Private/Language/locallang_db.xlf:tx_hotelbooking_domain_model_booking.price',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'double2'
