...
/**
 * Test case for class \RGJL\HotelBooking\Domain\Model\Price.
 *
...
class PriceTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \RGJL\HotelBooking\Domain\Model\Price
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \RGJL\HotelBooking\Domain\Model\Price();
	}
	 ...
	 * @test
	 */
	public function getDayPriceReturnsInitialValueForFloat() {
		$this->assertSame(
			0.0,
			$this->subject->getDayPrice()
		);
	}
	 ...
	 * @test
	 */
	public function setDayPriceForFloatSetsDayPrice() {
		$this->subject->setDayPrice(3.14159265);
	 ...
	 * @test
	 */
	public function getWeekPriceReturnsInitialValueForFloat() {
		$this->assertSame(
			0.0,
			$this->subject->getWeekPrice()
		);
	}
	 ...
	 * @test
	 */
	public function setWeekPriceForFloatSetsWeekPrice() {
		$this->subject->setWeekPrice(3.14159265);
